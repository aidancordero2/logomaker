...
from src.logomaker.Glyph import Glyph
from src.logomaker.validate import validate_matrix, validate_numeric
from src.logomaker.error_handling import check, handle_errors
from src.logomaker.colors import get_color_dict, get_rgb
from src.logomaker.matrix import transform_matrix
...
class Logo:
    ...
    **kwargs:
    ...
    def _compute_glyphs(self):
        ...
        # 2025.01.20 Fix for Issue #36 - Define dtype of glyph_df to be object
