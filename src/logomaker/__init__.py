# Specify version
__version__ = '0.8.12'  # Updated 2025.01.30
...
# Local imports
from src.logomaker.Logo import Logo
from src.logomaker.Glyph import Glyph, list_font_names
from src.logomaker.matrix import (
    transform_matrix,
    sequence_to_matrix,
    alignment_to_matrix,
    saliency_to_matrix,
...
from src.logomaker.colors import list_color_schemes
from src.logomaker.examples import (
    list_example_matrices,
    get_example_matrix,
    list_example_datafiles,
    open_example_datafile
)
from src.logomaker.error_handling import check, handle_errors, LogomakerError
