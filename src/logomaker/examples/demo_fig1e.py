...
from src import logomaker as logomaker

# load ARS enrichment matrix
ars_df = src.get_example_matrix('ars_enrichment_matrix',
                                print_description=False)

# load wild-type ARS1 sequence
with src.open_example_datafile('ars_wt_sequence.txt',
